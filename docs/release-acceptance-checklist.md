...
- 设置目标期数后可查看预计总投入、剩余投入和预计完成日期；定投概览可对照近 30 天实际投入、近 6 个自然月投入趋势与未来 30 天计划投入，人民币与美元分别汇总且趋势独立缩放。实际投入只统计已生成的定投买入流水；未来投入展示预计期数、涉及计划数，并按计划展示预计投入、单期金额及首末执行日期，暂停、归档和已完成计划不计入未来投入。
