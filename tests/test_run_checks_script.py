...
EXPECTED_COMPILE_TARGETS = (
    ...
    "goldmonitor/market_quality_alerts.py",
    "goldmonitor/market_quality_history.py",
    ...
    "tests/test_market_quality_alerts_module.py",
    "tests/test_market_quality_history_module.py",
    ...
    "tests/test_lan_dashboard_module.py",
    "tests/test_lan_dashboard_app.py",
