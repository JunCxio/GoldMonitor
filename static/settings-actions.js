function saveSettings() {
  ...
  const next = {
    ...
    market_quality_alert_enabled: document.getElementById('setMarketQualityAlertEnabled').checked,
    market_quality_alert_threshold_minutes: document.getElementById('setMarketQualityAlertThreshold').value,
    market_quality_alert_local_enabled: document.getElementById('setMarketQualityAlertLocal').checked,
    ...
    lan_dashboard_enabled: document.getElementById('setLanDashboardEnabled').checked,
    lan_dashboard_host: document.getElementById('setLanDashboardHost').value,
    lan_dashboard_port: document.getElementById('setLanDashboardPort').value.trim(),
    lan_dashboard_password: document.getElementById('setLanDashboardPassword').value,
    lan_dashboard_password_clear: document.getElementById('clearLanDashboardPassword').checked,
