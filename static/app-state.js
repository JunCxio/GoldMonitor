...
let portfolioInvestmentSimulations = {};
let portfolioInvestmentSimulationSeq = 0;
...
let appSettings = {
  ...
  lan_dashboard_password_configured: false,
  lan_dashboard_password_masked: '',
  lan_dashboard_status: {},
  lan_dashboard_interfaces: [],
  export_dir: '',
  export_dir_default: '',
